...
PORT=8401
LOG_FILE="$_SROOT/logs/step3-vl-10b.log"
PID_FILE="$_SROOT/logs/step3-vl-10b.pid"

MODEL_PATH="/mnt/volume3/hf_models/seanbailey518/Step3-VL-10B-GGUF/Step3-VL-10B-Q4_K_M.gguf"
...
start() {
    ...
    log_info "启动 Step3-VL-10B (32K)..."
    log_info "模型: 10B 参数, Q4_K_M 量化"
...
status() {
    echo "=========================================="
    echo "Step3-VL-10B Server (端口 $PORT)"
    echo "=========================================="
    if is_running; then
