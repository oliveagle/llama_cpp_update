#!/usr/bin/env python3
"""
测试 Qwen3.5-27B 的最终极限 Context 长度
"""
...
def main():
    print("="*70)
    print("Qwen3.5-27B 最终极限 Context 长度测试")
    print("="*70)
    print()

    # 从 128K 开始往上试
    ctx_sizes_to_test = [131072, 163840, 196608, 262144]
    results = []
    ...
    for r in results:
        if r['success']:
            print(f"✅ {r['ctx_size']:6d}: 成功 ({r['tokens']} tokens, {r['tps']:.1f} t/s, {r['elapsed']:.1f}s)")
        else:
