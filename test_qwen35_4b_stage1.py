#!/usr/bin/env python3
"""
Qwen3.5-4B-UD-Q4_K_XL - Stage 1 性能测试
测试内容:
...
# ============== 配置 ==============
MODEL_PATH = "/mnt/volume3/modelscope_models/unsloth/Qwen3___5-4B-GGUF/Qwen3.5-4B-UD-Q4_K_XL.gguf"
...
def main():
    ...
    # 选择后端
    print("="*80)
    print("🎯 Qwen3.5-4B-UD-Q4_K_XL Stage 1 性能测试")
    print("="*80)
    print("请选择测试后端:")
