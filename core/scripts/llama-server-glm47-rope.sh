#!/bin/bash
# GLM-4.7-Flash RoPE 缩放服务器
set -e

_SROOT="$(cd "$(dirname "$(realpath "$0")")" && pwd -P)"
SERVER_BIN="/home/oliveagle/opt/llama.cpp/build/bin/llama-server"
PORT=8401
LOG_FILE="$_SROOT/logs/glm47-rope.log"
PID_FILE="$_SROOT/logs/glm47-rope.pid"

MODEL_PATH="/mnt/volume3/modelscope_models/unsloth/GLM-4___7-Flash-GGUF/GLM-4.7-Flash-Q4_K_M.gguf"
ROPE_SCALE=4.0
...
start() {
    ...
    log_info "启动 GLM-4.7-Flash + RoPE (32K->128K)..."
